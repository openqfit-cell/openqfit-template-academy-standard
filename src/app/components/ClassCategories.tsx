    ...
    <AnimatedSection id="classes" delay={0.05} className="py-16 md:py-20 bg-white">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="mt-10 bg-gray-50 border border-gray-200 rounded-lg p-6 md:p-8 text-center">
          ...
          <a 
            href="#contact"
            className="inline-block bg-blue-600 text-white px-8 py-3 rounded-md hover:bg-blue-700 font-medium transition-all duration-300 hover:shadow-lg hover:-translate-y-1 shadow-sm">
