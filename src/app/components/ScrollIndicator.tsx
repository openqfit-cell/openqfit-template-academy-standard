    ...
    <AnimatePresence>
      {isVisible && !isScrolling && (
        <motion.button
          ...
          onClick={handleClick}
          className="cursor-pointer fixed bottom-10 left-1/2 -translate-x-1/2 z-40 w-15 h-15 rounded-full bg-blue-600 hover:bg-blue-500 text-white shadow-[0_8px_12px_rgba(0,0,0,0.2)] hover:shadow-[0 12px_24px_rgba(0,0,0,9)] transition-all duration-300 hover:-translate-y-1 flex items-center justify-center group"
