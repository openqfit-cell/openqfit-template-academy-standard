...
export function Hero() {
  return (
    <section className="relative bg-gradient-to-b from-gray-50 to-white">
      <div className="max-w-6xl mx-auto px-10 lg:px-7 py-16 sm:py-24 lg:py-8">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="order-1 text-center lg:text-left">
            ...
            <motion.div
              ...
              className="relative z-10 flex flex-row gap-8 justify-center lg:justify-start">
              {heroData.stats.map((stat) => {
                ...
                return (
                  <div key={stat.label} className="flex flex-col sm:flex-row items-center gap-3 text-center sm:text-left hover:scale-115 duration-300">
                    ...
                    <div>
                      <p className="text-2xl font-bold text-gray-100 lg:text-gray-900"><CountUp value={stat.value} /></p>
